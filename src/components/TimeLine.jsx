                ...
                <div class="relative">
                  <div class="md:flex items-center md:space-x-4 mb-3">
                    <div class="flex items-center space-x-4 md:space-x-2 md:space-x-reverse">
                      ...
                      <time class="font-caveat font-medium text-xl text-cyan-500 md:w-28">
                        FEB 2018
                      </time>
                    </div>
                  ...
                  <div class="p-4 rounded text-gray-500 dark:text-white shadow-md shadow-gray-500 ml-14 md:ml-44">
                    ...
                    handling a range of routine and special requirements.
                  </div>
                </div>
                <div class="relative">
                  <div class="md:flex items-center md:space-x-4 mb-3">
                ...
                <div class="relative">
                  <div class="md:flex items-center md:space-x-4 mb-3">
                    <div class="flex items-center space-x-4 md:space-x-2 md:space-x-reverse">
                      ...
                      <time class="font-medium text-xl text-cyan-500 md:w-28">
                        FEB 2023
                      </time>
                    </div>
