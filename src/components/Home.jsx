    ...
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          <h2 className="text-4xl sm:text-7xl font-bold text-gray-500 dark:text-white">
            Jhon Earvin Tangonan
          </h2>
          <h4 className="text-gray-500 dark:text-white pt-3 font-bold text-2xl">
            I'm
        ...
        <div>
          <img
            src={HeroImage}
            alt="my profile"
            className="border-4 border-gray-500 dark:border-white rounded-full mx-auto w-2/3 md:w-full"
          />
        </div>
      </div>
    </div>
